...
| **`F1`** | **Cycle Color** | Cycle through high-contrast colors (Neon Green -> OSRS Gold -> Cyan -> Crimson -> Hot Pink -> Amber -> White) |
| **`F2`** | **Cycle Size** | Cycle reticle size (1.0x -> 1.5x -> 2.0x -> 2.5x -> 3.2x) |
